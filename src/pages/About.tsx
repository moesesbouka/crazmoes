...
import { Clock, MapPin, Phone, Mail, Facebook, Heart, Star, Truck, Shield, Award, Package } from "lucide-react";
          ...
          <div className="max-w-4xl mx-auto">
            <div className="bg-card rounded-3xl p-8 md:p-12 shadow-card border border-border/50">
              <h2 className="font-display text-2xl md:text-3xl font-bold text-foreground mb-6 text-center">
                How We Bring You Unbeatable Deals
              </h2>
              <div className="space-y-4 text-muted-foreground">
                ...
                <p>
                  Liquidation inventory offers smart shoppers savings of <strong className="text-foreground">50-90% off retail prices</strong>. You're getting the same brand-name products you'd find at major retailers, just at a fraction of the cost. These items may have minor cosmetic imperfections, be overstock, or simply be returns that are in perfect working condition.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <div className="bg-card rounded-3xl p-8 shadow-card border border-border/50 text-center animate-fade-in-up opacity-0" style={{ animationDelay: '100ms' }}>
              <div className="inline-flex h-16 w-16 items-center justify-center rounded-2xl bg-fun-orange/20 mb-4">
                <Shield className="h-8 w-8 text-fun-orange" />
              </div>
            ...
            <div className="bg-card rounded-3xl p-8 shadow-card border border-border/50 text-center animate-fade-in-up opacity-0" style={{ animationDelay: '200ms' }}>
              <div className="inline-flex h-16 w-16 items-center justify-center rounded-2xl bg-fun-teal/20 mb-4">
                <Package className="h-8 w-8 text-fun-teal" />
              </div>
            ...
            <div className="bg-card rounded-3xl p-8 shadow-card border border-border/50 text-center animate-fade-in-up opacity-0" style={{ animationDelay: '300ms' }}>
              <div className="inline-flex h-16 w-16 items-center justify-center rounded-2xl bg-fun-pink/20 mb-4">
                <Star className="h-8 w-8 text-fun-pink" />
              </div>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className="space-y-6">
              ...
              <div className="bg-gradient-to-br from-fun-orange/10 to-fun-pink/10 rounded-3xl p-8 border border-border/50">
                ...
                <Button asChild className="w-full mt-6 hero-gradient font-bold rounded-xl">
        ...
        <div className="container">
          <div className="max-w-2xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button size="lg" className="hero-gradient font-bold rounded-xl">
      ...
      <section className="py-16 relative overflow-hidden">
        ...
        <div className="container">
          <div className="max-w-2xl mx-auto text-center">
            ...
            <Button asChild size="lg" className="hero-gradient font-bold text-lg px-8 py-6 rounded-2xl shadow-glow hover:scale-105 transition-transform">
              <Link to="/shop">
                Start Shopping
              </Link>
            </Button>
